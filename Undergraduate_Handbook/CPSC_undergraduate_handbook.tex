...
\newcommand{\abstractcourse}[5]{
  \node [#1] (#3) at (#4, #5) {#2 #3};
}

\newcommand{\criticalcourse}[4]{
  \abstractcourse{draw, rounded corners, pattern=north west lines, pattern color=black!30!white}{#1}{#2}{#3}{#4}
}

\newcommand{\course}[4]{
  \abstractcourse{draw, rounded corners}{#1}{#2}{#3}{#4}
}
...
\newcommand{\introtree}[1]{
  \criticalcourse{CPSC}{120}{#1}{0}
  \criticalcourse{CPSC}{121}{#1}{-1}
  \criticalcourse{CPSC}{131}{#1}{-2}
...
\newcommand{\majortree}{
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \criticalcourse{MATH}{150A}{0}{0}
      \criticalcourse{MATH}{150B}{0}{-1}
      \criticalcourse{MATH}{338}{0}{-4}
      \straightprereq{150B}{150A}
      \straightprereq{338}{150B}

      % MATH 270A-270B column
      \criticalcourse{MATH}{270A}{3}{0}
      \criticalcourse{MATH}{270B}{3}{-1}
      \straightprereq{270B}{270A}

      % CPSC 120-121-131-254-EPP-323 column
      \introtree{9}
      \criticalcourse{CPSC}{254}{9}{-3}
      \criticalcourse{CPSC}{301}{9}{-4}
      \course{CPSC}{323}{9}{-5}
      ...
      % 335, 481 under 270
      \criticalcourse{CPSC}{335}{3}{-5}
      \criticalcourse{CPSC}{481}{3}{-6}
      ...
      \course{CPSC}{240}{5}{-3}
      \course{CPSC}{223}{7}{-3}
      \course{CPSC}{332}{11}{-3}
      \course{CPSC}{311}{14}{-3}
      ...
      % 351, 471 under 254
      \course{CPSC}{351}{12}{-4}
      \course{CPSC}{471}{12}{-6}
      \straightprereq{351}{254} \coreq{351}{301}
      \straightprereq{471}{351}

      % 362, ENGL 101 aligned with 311
      \course{ENGL}{101}{14}{0}
      \course{CPSC}{362}{14}{-5}
      \straightprereq{311}{101} \bentprereq{311}{131}{bend left=15}
      \straightprereq{362}{301} \straightprereq{362}{311}

      % 315
      \course{CPSC}{315}{15}{-4}
      \straightprereq{315}{311}

      % legend
      \node at (12.5, -9) {\underline{Legend}};
      
      \criticalcourse{time-critical}{course}{10}{-10}
      
      \course{}{other course}{10}{-11}
...
\newcommand{\minortree}{
  \begin{center}
    \begin{tikzpicture}
      ...
      \criticalcourse{CPSC}{elective}{0}{-3}
...
\tikzstyle{flowstyle}=[rotate=-90]

\newenvironment{flowchart}{
    \begin{tikzpicture}[flowstyle]
}{
    \end{tikzpicture}
}

\newcommand{\flowchartlabel}[3]{
  \node [flowstyle, align=left] at (#1, #2) {#3};
}
...
\newcommand{\abstractflowchartcourse}[3]{
  \node [flowstyle, draw, rectangle, fill=#1, minimum width=1.8, minimum height=1.8, align=left] at (\flowX, \flowY) (#2) {#3};
  \SUBTRACT{\flowY}{2}{\flowY}
}

\newcommand{\cpsccourse}[1]{
  \abstractflowchartcourse{red!30!white}{#1}{CPSC #1}
}

\newcommand{\mathcourse}[1]{
  \abstractflowchartcourse{blue!30!white}{#1}{MATH #1}
}

\newcommand{\scienceelective}[2]{
  \abstractflowchartcourse{green!30!white}{#1}{#2}
}

\newcommand{\gecourse}[3]{
  \abstractflowchartcourse{yellow!30!white}{#1}{GE #2 \\ #3}
}

\newcommand{\trackcourse}[2]{
  \abstractflowchartcourse{red!10!white}{#1}{#2}
}

\newcommand{\freeelective}[1]{
  \trackcourse{#1}{Free \\ Elective}
}

% first 7 semesters, pass 223, science/math electives, and last class in semesters 5-7 as arguments
% \flowchartphaseone{title}{223 course}{science 1}{science 2}{science 3}{last class semester 5}{last class semester 6}{last class semester 7}
\newcommand{\flowchartphaseone}[8]{
...
% fill in last class in semesters 5-6 with the ones that are used for all tracks except MG
% \flowchartphaseone{title}{223 course}{science 1}{science 2}{science 3}{last class semester 7}
\newcommand{\flowchartphasetwo}[6]{
  \flowchartphaseone{#1}{#2}{#3}{#4}{#5}{\cpsccourse{315}}{\cpsccourse{362}}{#6}
}

% fill in science electives with default choices, 223 still an argument
% \flowchartphase2{title}{223 course}{last course in 7th semester}
\newcommand{\flowchartphasethree}[3]{
  \flowchartphasetwo{#1}{#2}{\scienceelective{270A}{MATH 250A}}{\scienceelective{225}{PHYS 225+L}}{\scienceelective{226}{PHYS 226+L}}{#3}
}

\newcommand{\mgtrack}{
  \begin{flowchart}
    \flowchartphaseone{Multimedia and Digital Games (MG)}{223P}{\scienceelective{270A}{MATH 250A}}{\scienceelective{225}{PHYS 225+L}}{\scienceelective{226}{PHYS 226+L}}{\trackcourse{386}{CPSC 386}}{\trackcourse{484}{CPSC 484}}{\trackcourse{486}{CPSC 486}}

    \trackcourse{489}{CPSC 489}
    \cpsccourse{315}
    \cpsccourse{362}
    \freeelective{FE1}
...
\newcommand{\ietrack}{
  \begin{flowchart}
    \flowchartphasethree{Internet and Enterprise Computing Technologies (IE)}{223J}{\trackcourse{431}{CPSC 431}}

    \trackcourse{473}{CPSC 473}
    \trackcourse{476}{CPSC 476}
    \freeelective{FE1}
    \freeelective{FE2}
...
\newcommand{\setrack}{
  \begin{flowchart}
    \flowchartphasethree{Software Engineering (SE)}{223P}{\trackcourse{462}{CPSC 462}}

    \trackcourse{464}{CPSC 464}
    \trackcourse{463}{CPSC 463/466}
    \freeelective{FE1}
    \freeelective{FE2}
...
\newcommand{\sctrack}{
  \begin{flowchart}
    \flowchartphasetwo{Scientific Computing (SC)}{223P}{\scienceelective{270A}{MATH 250A}}{\scienceelective{250B}{MATH 250B}}{\scienceelective{226}{PHYS 225+L}}{\trackcourse{370}{MATH 370}}

    \trackcourse{340}{MATH 340}
    \freeelective{FE1}
    \freeelective{FE2}
    \freeelective{FE3}    
...
\newcommand{\ctbiotrack}{
  \begin{flowchart}
    \flowchartphasetwo{Custom Track (CT) --- Bioinformatics Focus}{223P}{\scienceelective{120A}{CHEM 120A}}{\scienceelective{125}{CHEM 125}}{\scienceelective{172}{BIOL 172}}{\trackcourse{273}{BIOL 273}}


    \trackcourse{485}{CPSC 485}
    \trackcourse{483}{CPSC 483}
    \freeelective{FE1}
    \freeelective{FE2}
    
  \end{flowchart}
}
\newcommand{\ctsecuritytrack}{
  \begin{flowchart}
    \flowchartphasethree{Custom Track (CT) --- Cybersecurity Focus}{223C}{\trackcourse{353}{CPSC 353}}

    \trackcourse{452}{CPSC 452}
    \trackcourse{454}{CPSC 454}
    \trackcourse{456}{CPSC 456}
    \trackcourse{439}{CPSC 439}
...
\begin{tip}
Choose \emph{CPSC 223J - Java Programming} if you plan on taking web-related courses later on. Definitely take 223J if you plan on following the \emph{Internet and Enterprise Computing Technologies (IE)} track\index{Internet and Enterprise Computing (IE) track}.
\end{tip}
...
The requirements for the CS minor are \href{http://catalog.fullerton.edu/preview_program.php?catoid=2&poid=538&returnto=137}{detailed in the University Catalog}. You are required to complete the following courses:
\begin{enumerate}
...
The following flowcharts are examples of semester-by-semester course plans for various trajectories through the BS program. These plans complete all major requirements in 8 semesters (4 years), satisfy all prerequisites along the way, and obey all tips in this Handbook. There are flowcharts for the following academic plans:
\begin{enumerate}
\item \emph{Multimedia and Digital Games (MG)} track
\item \emph{Internet and Enterprise Computing (IE)} track
\item \emph{Software Engineering (SE)} track
\item \emph{Scientific Computing (SC)} track
\item \emph{Customized} track --- Bioinformatics Focus
\item \emph{Customized} track --- Cybersecurity Focus
\end{enumerate}
...
\clearpage \setrack
\clearpage \sctrack
\clearpage \ctbiotrack
\clearpage \ctsecuritytrack
