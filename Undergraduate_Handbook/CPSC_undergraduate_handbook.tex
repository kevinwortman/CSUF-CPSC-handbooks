...
% track entries
\newcommand{\maketrackindex}[2]{
  \newcommand{#1}{\index{track!#2}}
}
\maketrackindex{\mgtrackindex}{\mgtrackname}
\maketrackindex{\ietrackindex}{\ietrackname}
\maketrackindex{\setrackindex}{\setrackname}
\maketrackindex{\sctrackindex}{\sctrackname}
\maketrackindex{\cttrackindex}{\cttrackname}
\maketrackindex{\ctbiotrackindex}{\ctbiotrackname}
\maketrackindex{\ctsecuritytrackindex}{\ctsecuritytrackname}
...
\newcommand{\mgtrack}{
  \begin{flowchart}
    \flowchartphaseone{\mgtrackname}{223P}{\scienceelective{270A}{MATH 250A}}{\scienceelective{225}{PHYS 225+L}}{\scienceelective{226}{PHYS 226+L}}{\trackcourse{386}{CPSC 386}}{\trackcourse{484}{CPSC 484}}{\trackcourse{486}{CPSC 486}}
...
\newcommand{\ietrack}{
  \begin{flowchart}
    \flowchartphasethree{\ietrackname}{223J}{\trackcourse{431}{CPSC 431}}
...
\newcommand{\setrack}{
  \begin{flowchart}
    \flowchartphasethree{\setrackname}{223P}{\trackcourse{462}{CPSC 462}}
...
\newcommand{\sctrack}{
  \begin{flowchart}
    \flowchartphasetwo{\sctrackname}{223P}{\scienceelective{270A}{MATH 250A}}{\scienceelective{250B}{MATH 250B}}{\scienceelective{226}{PHYS 225+L}}{\trackcourse{370}{MATH 370}}
...
\newcommand{\ctbiotrack}{
  \begin{flowchart}
    \flowchartphasetwo{\ctbiotrackname}{223P}{\scienceelective{120A}{CHEM 120A}}{\scienceelective{125}{CHEM 125}}{\scienceelective{172}{BIOL 172}}{\trackcourse{273}{BIOL 273}}
...
\newcommand{\ctsecuritytrack}{
  \begin{flowchart}
    \flowchartphasethree{\ctsecuritytrackname}{223C}{\trackcourse{353}{CPSC 353}}
...
\begin{tip} \index{unit limit}
  You are ordinarily limited to 16 units each term. In order to finish the BS program in 8 semesters, you will need to take five classes each semester. Almost all CPSC and GE courses are 3 units each; almost all mathematics and science courses are 4 units each. Plan on taking four 3-unit courses (CPSC and/or GE), and one 4-unit course (mathematics or science) each semester, for a total of 16 units, until you are nearing graduation.
\end{tip}
...
\clearpage \mgtrack \mgtrackindex

\clearpage \ietrack \ietrackindex

\clearpage \setrack \setrackindex

\clearpage \sctrack \sctrackindex

\clearpage \ctbiotrack \ctbiotrackindex

\clearpage \ctsecuritytrack \ctsecuritytrackindex
