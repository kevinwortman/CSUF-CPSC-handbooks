...
The requirements for the CS minor are detailed in the University Catalog (\url{http://bit.ly/28ULcBr}). You are required to complete the following courses:
\begin{enumerate}
...
See the Student Rights section of the Catalog (\url{http://bit.ly/28RvnaE}) for more information on petitions.
