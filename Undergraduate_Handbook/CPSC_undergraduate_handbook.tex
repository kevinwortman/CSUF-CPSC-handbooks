...
\newcommand{\shrunkurl}[1]{\url{https://csuf-cpsc.appspot.com/#1}}
...
\item Advising:
  ...
  \item Student Success Center: \shrunkurl{ssc}
    ...
    \end{itemize}
\item Department of Computer Science website: \shrunkurl{cs}
\item General Education (GE) website: \shrunkurl{ge}
