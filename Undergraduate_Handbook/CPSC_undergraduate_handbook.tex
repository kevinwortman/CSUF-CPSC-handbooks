...
Our accreditor, ABET\index{ABET}, requires at least 30 units of mathematics and science courses. The Mathematics Requirements and Science and Mathematics Electives together satisfy the 30-unit requirement.
...
Our introductory programming courses are taught in C++, but cover concepts that are common to practically all programming languages. To establish some breadth of programming fluency, you are required to learn a second object-oriented programming language. This is accomplished by passing one of the CPSC 223 courses, or equivalent.

\begin{tip}
  CPSC 223J - Java Programming (3) is a prerequisite to CPSC 376 - Client/Server Systems with Java (3) and CPSC 476 - Java Enterprise Application Development (3). CPSC 476 is required for the Internet and Enterprise Computing Technologies (IE) track. If you anticipate taking the IE track, or taking 376 or 476 as a Free Elective, choose 223J.
\end{tip}
...
As \href{http://catalog.fullerton.edu/preview_program.php?catoid=2&poid=537&returnto=137}{stated in the University Catalog}, you must complete at least 12 units of natural science and/or mathematics courses chosen from a designated list. The list includes only courses that dovetail with CS material, and may fit within a coherent 12-unit curriculum. Due to GE and ABET requirements, you must take at least one course with a hands-on laboratory experience. Eligile laboratory courses are designated in the Catalog.
...
\newcommand{\gecourselist}{ \href{http://www.fullerton.edu/undergraduate/generaledu/ge_approvedcourses.asp}{How do I find which courses are approved for GE?} }
...
\begin{tabular}{| p{3in} | p{3in} |} \hline
  \textbf{GE requirement} & \textbf{Satisfied by} \\ \hline
  ...
  B.4. Mathematics and Quantitative Reasoning (3 units) & MATH 150A, required for Mathematics Requirements \\ \hline
  B.5. Implications and Explorations of Mathematics and Natural Sciences (3 units) & MATH 338, required for Mathematics Requirements \\ \hline
...
\begin{tabular}{| p{3in} | p{3in} |} \hline
  ...
  D.1. Introduction to Social Sciences (3 units) & EGCE/CP/EE/ME 401 \\ \hline
...
\begin{tip}
  To conserve units, take HIST 110A to satisfy area C.4.
  \end{tip}

\begin{tip}
To satisfy the upper-division GE requirement with minimal courses, take EGCE/CP/EE/ME 401 to satisfy GE area D.1.
\end{tip}
