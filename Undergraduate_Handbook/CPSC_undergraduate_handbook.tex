...
\begin{tip}
Choose \emph{CPSC 223J - Java Programming} if you plan on taking web-related courses later on. Definitely take 223J if you plan on following the Internet and Enterprise Computing Technologies (IE) track\index{Internet and Enterprise Computing (IE) track}.
\end{tip}
