...
\newcommand{\MinorTree}{
  \begin{center}
    \begin{tikzpicture}
      ...
      \TimeCriticalTreeCourse{CPSC}{elective 1}{-3}{-3}
      \TimeCriticalTreeCourse{CPSC}{elective 2}{3}{-3}
      \StraightPrereq{elective 1}{131}
      \StraightPrereq{elective 2}{131}
...
At least 12 units, including the minimum 6 units of upper division
course work, must be courses that are not being used to fulfill
requirements for your major.

The following are prerequisites for most upper-division Computer
Science courses, including CPSC 313, CPSC 332, CPSC 353 and CPSC
386. It is recommended that Computer Science minors complete them
first. Other CPSC courses may require additional prerequisites.
\begin{itemize}
  \item CPSC 120 - Introduction to Programming (3)
  \item CPSC 121 - Object-Oriented Programming (3)
  \item CPSC 131 - Data Structures (3)
\end{itemize}

If you count those courses toward your minor, you will still need to
complete 6 units of upper-division Computer Science courses at
\CampusName. You may have to take additional courses to meet the
prerequisites for your CS courses. The upper-division courses that are
available to students after successfully completing CPSC 131 are CPSC
313, CPSC 332, CPSC 349, CPSC 351, CPSC 353, and CPSC 386. Upper
division courses that you can take after taking and passing the EPP
are CPSC 323 and CPSC 411. If a student completes MATH 270B or MATH
280, CPSC 439 is an option.
...
351, so none of these count toward the 12-unit requirement. A Computer
Engineering major may count only 3 of these units toward a Computer
Science minor. To complete the minor they must pass at least 12
additional units of CPSC courses that are distinct from their
major. Altogether, a Computer Engineering major must usually pass
a total of 25 units of CPSC course work to complete a Computer Science
minor.
