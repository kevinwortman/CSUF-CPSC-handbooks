...
\newcommand{\flowcharttemplate}[3]{
  ...
  \scienceelective{250A}{MATH 250A} %\bentprereq{250A}{150B}{bend left}
  \cpsccourse{#2}
  \cpsccourse{240}
  ...
  \scienceelective{225}{PHYS 225+L}
  \cpsccourse{332}
  ...
  \scienceelective{226}{PHYS 226+L} %\straightprereq{226}{225}
  \cpsccourse{351}
  \cpsccourse{323}
...
\newcommand{\ietrack}{
  \begin{flowchart}
    \flowcharttemplate{Internet and Enterprise Computing Technologies (IE)}{223J}{\trackcourse{431}{CPSC 431}}
...
\newcommand{\setrack}{
  \begin{flowchart}
    \flowcharttemplate{Software Engineering (SE)}{223P}{\trackcourse{462}{CPSC 462}}
...
\newcommand{\ctsecuritytrack}{
  \begin{flowchart}
    \flowcharttemplate{Custom Track (CT) --- Cybersecurity Focus}{223C}{\trackcourse{353}{CPSC 353}}

    \springsemester
    \trackcourse{452}{CPSC 452}
    \trackcourse{454}{CPSC 454}
    \trackcourse{439}{CPSC 439}
    \trackcourse{463}{CPSC 463}
